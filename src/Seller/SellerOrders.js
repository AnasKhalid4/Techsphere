...
const SellerOrders = () => {
  ...
  const handleSearchChange = () => {
    ...
    if (!searchTerm.trim()) {
      ...
      const filtered = allOrders.filter((product) => product.name.toLowerCase().includes(searchTerm.toLowerCase())
      );
                            ...
                            <td className="px-6 py-4">
                              <div className="">
                                <p className="text-base font-semibold">
                                  <p className="text-black">{order.Lastname}</p>
                                </p>
