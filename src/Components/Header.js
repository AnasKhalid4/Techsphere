      ...
      <ul className={menuClick ? "nav-menu active" : "nav-menu"}>
        {navMenu.map((item, index) => (
          <li key={index}>
            ...
            >
              {item.title}
              <div className=" absolute top-10 -left-3 hidden group-hover:flex hover:flex  group-hover:flex-col items-center justify-center p-4 gap-2 bg-slate-100 shadow-lg rounded-lg">
                <Link
                  to="/LaptopPage"
